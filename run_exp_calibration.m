function [data] = run_exp_calibration(idx,savedata,save_folder,BPU,PA)
    tic
    close all;
    % repeat = 10;
    data = [];
...
%     [rx97, H97, r97, SNR97, n97, BPU, PA, maxk_pos97, maxk_pks97] = measure_cs_multipath_codebook(cb, BPU, PA);
%     data.rx_ex_probes = rx97;
    
    % ACO probes
    create_csi_codebook(124, 1, PA.ACTIVE_ANT(2:32), PA);
    cb = "./codebooks/csi.mat";
    [rx4, H4, r4, SNR4, n4, BPU, PA, maxk_pos4, maxk_pks4] = measure_cs_multipath_codebook(cb, BPU, PA);
...
%     cb = "./codebooks/cs.mat";
%     [rx1, H1, r1, SNR1, n1, BPU, PA, maxk_pos1, maxk_pks1] = measure_cs_multipath_codebook(cb, BPU, PA);
